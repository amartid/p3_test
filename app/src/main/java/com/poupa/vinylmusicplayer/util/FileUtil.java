...
public final class FileUtil {
    ...
    public static boolean checkFileMimeType(File file, String mimeType,MimeTypeMap mimeTypeMap) {

        String fileExtension = filename.substring(dotPos + 1).toLowerCase();
        String fileType = mimeTypeMap.getMimeTypeFromExtension(fileExtension);
    	
        if (!checkFilenameMimeTypeMap(file,mimeTypeMap))
    		return false;
        ...
        if (!mimeTypeSubtype.equals("*")) return false;
    ...
    public static boolean checkFilenameMimeTypeMap(File file, MimeTypeMap mimeTypeMap) {
    ...
    public static boolean fileIsMimeType(File file, String mimeType, MimeTypeMap mimeTypeMap) {
    	return (mimeType == null || mimeType.equals("*/*"))?true:checkFileMimeType(file,mimeType,mimeTypeMap);
    }
